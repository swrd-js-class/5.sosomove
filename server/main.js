...
const requestText = {
  car: [
    "안녕하세요, 고객님.\n이번 이사에 대한 소형 용달 차량 견적입니다.\n1톤 용달로 12만원 정도 예상됩니다.\n추가 옵션: 사다리차(3만 원 추가 가능)\n이사 날짜: 2024년 6월 15일\n출발지: 서울 서초구\n도착지: 서울 용산구\n추가 문의사항이 있으시면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이번 대형 이사에 대한 견적을 보내드립니다.\n차량 종류: 3.5톤 용달\n예상 비용: 25만 원\n추가 옵션: 포장 서비스(5만 원 추가 가능)\n이사 날짜: 2024년 8월 5일\n출발지: 서울 강남구\n도착지: 서울 송파구\n견적에 대한 추가 조율이 필요하시면 언제든지 연락 주시기 바랍니다.\n감사합니다.",

    "안녕하세요, 고객님.\n소형 이사에 대한 용달 차량 견적입니다.\n차량 종류: 1톤 용달\n예상 비용: 10만 원\n추가 옵션: 사다리차(3만 원 추가 가능)\n이사 날짜: 2024년 7월 10일\n출발지: 서울 마포구\n도착지: 서울 종로구\n궁금한 점이 있으면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이번 이사에 대한 견적을 보내드립니다.\n차량 종류: 2.5톤 용달\n예상 비용: 18만 원\n추가 옵션: 포장 서비스(4만 원 추가 가능)\n이사 날짜: 2024년 7월 25일\n출발지: 서울 영등포구\n도착지: 서울 강동구\n추가 서비스나 변경 사항이 있으시면 언제든지 문의 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n대형 이사 견적을 드립니다.\n차량 종류: 5톤 용달\n예상 비용: 40만 원\n추가 옵션: 박스 포장 서비스(6만 원 추가 가능)\n이사 날짜: 2024년 8월 20일\n출발지: 서울 관악구\n도착지: 서울 강남구\n추가로 필요한 사항이 있으시면 언제든지 연락 부탁드립니다.\n감사합니다.",

    "안녕하세요, 고객님.\n이번 소형 이사에 대한 견적을 보내드립니다.\n차량 종류: 1톤 용달\n예상 비용: 13만 원\n추가 옵션: 사다리차(3만 원 추가 가능)\n이사 날짜: 2024년 6월 30일\n출발지: 서울 동작구\n도착지: 서울 서대문구\n문의 사항이 있으면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n중형 이사에 대한 용달 견적입니다.\n차량 종류: 2.5톤 용달\n예상 비용: 20만 원\n추가 옵션: 박스 포장 서비스(4만 원 추가 가능)\n이사 날짜: 2024년 9월 10일\n출발지: 서울 강북구\n도착지: 서울 중구\n견적에 대해 궁금한 점이 있으면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n대형 이사 견적을 안내드립니다.\n차량 종류: 5톤 용달\n예상 비용: 45만 원\n추가 옵션: 포장 서비스(7만 원 추가 가능)\n이사 날짜: 2024년 10월 5일\n출발지: 서울 구로구\n도착지: 서울 서초구\n추가 문의사항이 있으시면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이번 소형 이사에 대한 용달 차량 견적입니다.\n차량 종류: 1톤 용달\n예상 비용: 11만 원\n추가 옵션: 사다리차(2만 원 추가 가능)\n이사 날짜: 2024년 6월 18일\n출발지: 서울 송파구\n도착지: 서울 강서구\n견적에 대한 추가 조율이 필요하시면 언제든지 연락 주시기 바랍니다.\n감사합니다."

  ],
  helper: [
    "안녕하세요, 고객님.\n이번 이사 포장 도우미 서비스 견적입니다.\n예상 비용: 15만 원(2인 기준) \n서비스 날짜: 2024년 6월 20일\n출발지: 서울 강남구\n도착지: 서울 송파구\n추가 요청 사항이 있으시면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이사 포장 도우미 서비스 견적을 안내드립니다.\n예상 비용: 18만 원(3인 기준) \n서비스 날짜: 2024년 7월 10일\n출발지: 서울 여의도\n도착지: 서울 마포구\n궁금한 점이 있으시면 언제든지 문의 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이사 포장 도우미 서비스 견적입니다.\n예상 비용: 12만 원(1인 기준) \n서비스 날짜: 2024년 7월 5일\n출발지: 서울 강북구\n도착지: 서울 중구\n추가 서비스나 요청 사항이 있으시면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이사 포장 도우미 서비스에 대한 견적을 드립니다.\n예상 비용: 22만 원(4인 기준) \n서비스 날짜: 2024년 7월 15일\n출발지: 서울 종로구\n도착지: 서울 강남구\n추가 요청 사항이 있으시면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이사 포장 도우미 서비스 견적을 안내드립니다.\n예상 비용: 25만 원(5인 기준) \n서비스 날짜: 2024년 8월 1일\n출발지: 서울 서초구\n도착지: 서울 강동구\n추가로 필요한 서비스가 있으면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이사 포장 도우미 서비스 견적입니다.\n예상 비용: 14만 원(2인 기준) \n서비스 날짜: 2024년 6월 25일\n출출발지: 서울 마포구\n도착지: 서울 은평구\n추가 요청 사항이 있으시면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이사 포장 도우미 서비스 견적을 보내드립니다.\n예상 비용: 20만 원(3인 기준) \n서비스 날짜: 2024년 7월 8일\n출발지: 서울 강서구\n도착지: 서울 금천구\n추가 요청 사항이 있으시면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이사 포장 도우미 서비스 견적입니다.\n예상 비용: 16만 원(2인 기준) \n서비스 날짜: 2024년 7월 12일\n출발지: 서울 동대문구\n도착지: 서울 성동구\n추가로 필요한 사항이 있으시면 언제든지 연락 주세요.\n감사합니다.",

    "안녕하세요, 고객님.\n이사 포장 도우미 서비스에 대한 견적을 보내드립니다.\n예상 비용: 19만 원(3인 기준) \n서비스 날짜: 2024년 8월 10일\n출발지: 서울 서초구\n도착지: 서울 관악구\n추가 서비스나 요청 사항이 있으시면 언제든지 연락 주세요.\n감사합니다.",
  ...
  if (Meteor.users.find({ 'profile.type': "헬퍼" }).count() === 0) {
    for (let i = 1; i <= 5; i++) {
      Accounts.createUser({
        ...
        profile: {
          type: "헬퍼",
          name: businessName.helper.random(),
          phone: phoneList.number.random(),
          company:
          {
            ceo_name: nameList.name.random(),
    ...
    requests.forEach(function (request) {
      users.forEach(function (estCaruser) {
        ...
        CollectionEstimate.insert({
          ...
          business_name: estCaruser.profile.company.company_name,
          business_contact: estCaruser.profile.phone,
          details: requestText.helper.random(),
          amount: ["20000", "30000", "40000", "50000", "60000", "70000", "80000", "90000"].random(),
          business_type: "헬퍼",
          status: 1,
          request_del_flag: false,
