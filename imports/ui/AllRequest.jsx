                    ...
                    <div className="overflow-hidden shadow ring-1 ring-black/5 sm:rounded-lg">
                        <table className="min-w-full divide-y divide-gray-300">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th scope="col" className="py-2 sm:py-3.5 pl-2 sm:pl-4 pr-2 sm:pr-3 text-left text-xs sm:text-sm font-semibold text-gray-900">요청자 이름</th>
                                    ...
                                    <th scope="col" className="relative py-2 sm:py-3.5 pl-2 sm:pl-3 pr-2 sm:pr-4">
                                ...
                                {filteredRequests.length > 0 ? (
                                    filteredRequests.map((request) => (
                                        <tr key={request._id}>
                                            ...
                                            <td className="relative whitespace-nowrap py-2 sm:py-4 pl-2 sm:pl-3 pr-2 sm:pr-4 text-right text-xs sm:text-sm font-medium">
                                                <Link
