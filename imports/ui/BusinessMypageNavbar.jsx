...
export default () => {
  ...
  return (
    <div class="relative flex flex-col bg-clip-border text-gray-700 h-full w-full max-w-[20rem] p-4  border-2">
      <div class="mb-5 p-4">
        ...
        <h5 class="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-gray-900 mb-8">마이페이지(사업자)</h5>
