...
export default () => {
  ...
  return (
    <div className="relative flex flex-col bg-clip-border text-gray-700 h-full w-full max-w-[20rem] p-4  border-2 font-semibold">
      <div className="mb-3 p-4">
        ...
        <h5 className="block antialiased tracking-normal text-xl font-semibold leading-snug text-gray-900 mb-8">마이페이지</h5>
        <div className="font-bold text-center bg-pink-200 rounded-lg">{user}님 환영합니다!</div>
      </div>
