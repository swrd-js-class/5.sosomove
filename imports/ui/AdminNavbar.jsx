  ...
  return (
    <div class="relative flex flex-col bg-clip-border text-gray-700 h-full w-full max-w-[20rem] p-4 border">
      <div class="mb-2 p-4">
        ...
        <h5 class="block antialiased tracking-normal text-xl font-semibold leading-snug text-gray-900">관리자페이지</h5>
      </div>
      <nav class="flex flex-col gap-1 min-w-[240px] p-4 text-base font-normal text-gray-700">
        <ul>
          <li class="mb-3">
