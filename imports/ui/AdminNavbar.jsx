...
export default () => {
  return (
    <div className="relative flex flex-col bg-clip-border text-gray-700 h-full w-full max-w-[20rem] p-4 border">
      <div className="mb-2 p-4">
        ...
        <h5 className="block antialiased tracking-normal text-xl font-semibold leading-snug text-gray-900">관리자페이지</h5>
      </div>
      <nav className="flex flex-col gap-1 min-w-[240px] p-4 text-base font-normal text-gray-700">
        <ul>
          <li className="mb-3">
          ...
          <li className="mb-3">
            <div role="button" tabindex="0" className="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
              ...
              <Link to="/admin/adminedit" >내 정보 관리</Link>
            </div>
          </li>
        </ul>
      </nav>
