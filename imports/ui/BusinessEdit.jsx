                ...
                <div className="px-4 py-5 sm:px-6">
                    <form onSubmit={handleSubmit}>
                        <div className="space-y-4">
                            ...
                            <div className="w-full">
                                <h2 className="text-sm font-medium text-gray-500">사업장명</h2>
                                <input 
                                    type="text" 
                                    value={name} 
                            ...
                            <div className="w-full">
                                <h2 className="text-sm font-medium text-gray-500">대표번호</h2>
                                <input 
                                    type="text" 
                                    value={phone} 
                            ...
                            <div className="w-full">
                                <h2 className="text-sm font-medium text-gray-500">대표자명</h2>
                                <input 
                                    type="text" 
                                    value={ceo_name} 
                            ...
                            <div className="w-full">
                                <h2 className="text-sm font-medium text-gray-500">사업장 주소</h2>
                                <input 
                                    type="text" 
                                    value={address} 
